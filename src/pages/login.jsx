...
const Login = () => {
    ...
    return (
        ...
        `}>
            ...
            `}>
                <div className="text-[22px] mb-[15px] mt-[40px] text-center">Welcome Back!</div>

                <form className="mt-[40px] justify-center" action="" onSubmit={loginHandler}>
                    ...
                    <div className="flex flex-col gap-y-[20px] mt-[45px] items-center">
                        <Button className="w-[50%] sm:w-[70%]" type="submit">Login</Button>
                        <div className="text-[14px]">
                            Don't have an account?
                            <span className="text-[#1A56DB] font-medium ml-[5px] cursor-pointer dark:text-[#D9D9D9] dark:underline" onClick={() => {router.push("/signup")}}>Sign Up</span>
                        </div>
                    </div>
                </form>
            </div>
